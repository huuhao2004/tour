...
if (revenueChart) {
  ...
  const fetchApi = async () => {
    const response = await fetch(`/${pathAdmin}/dashboard/revenue-chart`, {
      method: "POST",
      headers: {
          ...
          datasets: [
            {
              ...
              data: result.dataMonthCurrent,
              borderColor: "#36A1EA",
              boderWidth: 1.5,
            },
            {
              label: `Tháng ${previousMonth}/${previousYear}`,
              data: result.dataMonthPrevious,
              borderColor: "#FE6383",
              boderWidth: 1.5,
            },
          ],
...
if (profileChangePasswordForm) {
  ...
  validation
    ...
    .onSuccess((event) => {
      ...
      const fetchApi = async () => {
        const response = await fetch(`/${pathAdmin}/profile/change-password`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json"
          },
